...
/**
 * 
 * This class contains support vector machines methods.For each class, a number of perceptrons are created.
 * Perceptrons are then selected based on their performance.Perceptrons are used to classify the test data, 
 * and the one with the correct classification is selected.Data is classified according to the perceptron 
 * that has the correct classification.
 *
 */
