...
public class Main {
	...
	private static ReadFile training = new ReadFile(
			new File("C:\\Users\\mm3512\\Downloads\\COURSEWORK2AI\\COURSEWORK2AI\\M00735429AI\\Resources\\dataset1.csv"));

	//Read data from testing file 
	private static ReadFile testing = new ReadFile(
			new File("C:\\Users\\mm3512\\Downloads\\COURSEWORK2AI\\COURSEWORK2AI\\M00735429AI\\Resources\\dataset2.csv"));
